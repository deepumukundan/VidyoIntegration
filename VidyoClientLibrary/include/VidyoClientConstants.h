...
#define SIGNIN_PORTAL_ACCESS_KEY_SIZE (128+1)
...
#define PROXY_VIDYO_FORCE (1)					/*!< Force use of VidyoProxy */
...
#define PASSWORD_SIZE FIELD_SIZE
...
#define MAX_NUM_APP_WINDOWS 40 // Maximum number of open application windows
#define MAX_SHARE_DISPLAY_DEVICE 5 // Maximum allowed sharable display devices
#define MAX_REMOTE_SHARE_APP 40 // Maximum number of remotely shared applications
#define PARTICIPANTS_LIMIT_AUTO 16
#define MAX_EID_SIZE (64+1)	// endpoint ID string size
...
#define MAX_CHAT_MESSAGE_LEN	300+1 // Maximum length of text message (contents)
#define VIDYO_CLIENT_VERSION_SIZE 256 // Maximum size of VidyoClient version
...
#define MAX_IPADDRESS_LEN 48  // Max size of IPV6 in string is 39 charactors
//@}
